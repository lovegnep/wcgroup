...
const Chinese = '先说文章的结构，' +
    '即所要写的这篇记叙文用什么结构来表现出来。它包括这篇文章分几层写，哪些材料先写，哪些后写，哪些详写，' +
    '哪些略写，如何安排过渡，于何处伏笔，在哪里呼应，如何开头，怎样结尾，等等。从整篇记叙文来看、' +
    '常见的结构有顺序、倒叙、插叙。顺叙，就是按照事情发生、发展的，' +
    '过程进行叙述。包括以下几种情况:其一，按时间的推移来叙述;其二，' +
    '按事情的发展来叙述;其三，按认识发展的过程来叙述;其四，按作者的行踪来叙述。倒叙，就是把事情的结局，或某个突出的精彩片断提到前边写，' +
    '然后再按事件发生、发展的顺序叙述。倒叙的运用有四种类型:一种是把事件的结局提前，造成悬念，然后再按时间顺序叙述事情的发生与发展;' +
    '一种是把事件中最精彩的或最紧张的片断截取下来，写在前面，震动和吸引读者，然后按时间的顺序叙述事件的起因、发展与结局;' +
    '一种是先写眼前的事物，由此及彼，引起回忆，再追叙往事，形成倒叙，一种是先写当前情况，再回忆过去的情况，以形成鲜明的对比，' +
    '给读者留下深刻印象。插叙，是在文章的叙述中，暂时中断叙述的线索，插入一些与中心事件有关的内容，然后再继续进行原来的叙述。' +
    '插叙的具体内容和形式有种种不同:有的是追叙，对过去事件片断进行回忆，有的是补叙，对有关人和事作必要的补充、解释;有的是逆叙，' +
    '对有关内容由近及远、由今及古地回溯，灵活多样的插叙，可以使主题开掘得更深刻，情节展开得更充分，内容表现得更充实，人物形象刻画得更丰满，' +
    '避免了平辅直叙。'+
    ...
    '一天，我淘气的把妈妈煮好的鸡蛋放进了生鸡蛋里，过了好长时间，我告诉了妈妈，妈妈笑着说没关系，她能够区分出来。只见妈妈拿起箱里的一个鸡蛋，放在桌子上转动一下，又拿出一个，再转动，一会儿，妈妈拿着一个鸡蛋说：“就是它了，它就是那个熟鸡蛋。”我摸摸，鸡蛋没有了热气，再看看，看不出和生鸡蛋有什么区别，我不解，问妈妈原因。妈妈告诉我，看鸡蛋转动的速度就可以知道是生鸡蛋还是熟鸡蛋，生鸡蛋因为蛋壳内是液体，不容易转动，转动的速度较慢，而且转动的时间较短，熟鸡蛋内的蛋清和蛋黄变成了固体，鸡蛋容易转动，所以转动的较快，时间也比较长。我拿出一个生鸡蛋，在桌子上分别转动起两个鸡蛋来，果然是这样。转着转着，我又发现了一个鸡蛋转动中的问题：'+
    '我们都知道，也可能做过这样的试验，如果用一只手握住鸡蛋，用力挤压，不管你是一个平常人，还是一个大力士，都不可能把鸡蛋压碎。这里面也有一定的科学道理哟。这是一种物理现象，它和鸡蛋的形状有关：鸡蛋的形状是椭圆形的，它的这种拱形外壳能够把压力均匀地分散到蛋壳的每一个部分，用整个手掌捏时，由于手上的力量分散到整个鸡蛋的表面，压强很小，所以捏不碎。但如果同时两个手指捏鸡蛋，由于接触面小，压力集中在一个点上，鸡蛋自然容易碎。科学家根据并利用这个原理发明了隧道、拱桥、安全帽……大大方便了人们的生活。'+
    '我发现古人似乎是没有“青春期”的。青春期是动物的本能，不论是高级动物人类还是低级动物，都不例外。但是，我们的古人，似乎没有青春期，血气方刚的年轻人，不会对于父母的想法产生怀疑，觉得自己已经是大人的少男少女们，不想着脱离父母的控制像一个大人一样自己做主。这不就是因为孝道所产生的主流价值观导致的现象吗？孔子曾经说过，你看这个人孝不孝顺，你看他爹死了是不是不改其“志”。其实我是很反感这句话的，如今我们的个人意识比古人强的多，是可以看出里面的问题的，但是古人看来这是正常的，甚至是应当推崇的。这些孝文化中的糟粕，是必须剔除的。孝道确确实实有大量压制甚至泯灭人性的东西，他能极大的抑制人的本性，社会的活力和思想的活跃与更新。'
function getRandomGN(){
  let index = GetRandomNum(0,Chinese.length-10);
  return Chinese.substr(index,GetRandomNum(2,8));
}
function getRandomAB(){
  let index = GetRandomNum(0,Chinese.length-30);
  return Chinese.substr(index,GetRandomNum(10,30));
}
